...
<html>
	<head>
		...
		<?php
			...
			$name_firstCust = $_GET['name_firstCust'];
    		$name_lastCust = $_GET['name_lastCust'];
    		$addressCust = $_GET['addressCust'];
    		$phnumberCust = $_GET['phnumberCust'];
    		addCustomer($name_firstCust, $name_lastCust, $addressCust, $phnumberCust);
